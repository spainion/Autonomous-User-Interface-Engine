...
class CompleteUIGenerator:
    ...
    MAX_COMPONENTS_PER_PAGE = 10  # Limit components for reasonable page size
    ...
    def generate_complete_ui(
        ...
        for comp_category, comp_variant in required_components[:self.MAX_COMPONENTS_PER_PAGE]:
            try:
                ...
                print(f"      Warning: Could not generate {comp_category.value}/{comp_variant}: {str(e)}")
